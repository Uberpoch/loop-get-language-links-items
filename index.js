...
const { getItemLoop, langLoop } = require('./utils/loop');
const { sortItems } = require('./utils/data');
...
const run = async(argv) => {
    ...
    const loopResult = await getItemLoop(token, hub_id);
    const dataResult = await sortItems(loopResult);
